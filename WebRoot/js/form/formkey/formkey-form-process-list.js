...
function readForm(processDefinitionId) {
	...
	// 读取启动时的表单
	$.get(ctx + '/formKey_receiveStartForm.action?processDefinitionId=' + processDefinitionId, function(form) {
		...
		// 设置表单action
		$form.attr('action', ctx + '/formKey_startProcess.action?processDefinitionId=' + processDefinitionId);
