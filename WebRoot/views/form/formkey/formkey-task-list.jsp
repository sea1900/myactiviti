...
<head>
    ...
    <link href="${ctx }/jquery/plugins/qtip/jquery.qtip.min.css" type="text/css" rel="stylesheet" />
	...
	<script src="${ctx }/js/form/formkey/formkey-form-handler.js" type="text/javascript"></script>
</head>
		...
		<tr>
			...
			<td>
				<c:if test="${empty task.assignee }">
					<a class="claim" href="${ctx }/formKey_claim.action?taskId=${task.id}">签收</a>
				</c:if>
